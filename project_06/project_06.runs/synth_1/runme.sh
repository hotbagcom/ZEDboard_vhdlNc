...
HD_PWD='C:/Users/arify/WorkSpace/ZEDboard_vhdlNc/project_06/project_06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p05_dds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p05_dds.tcl
