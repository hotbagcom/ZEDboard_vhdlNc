...
xv_boost_lib_path=C:/Users/arify/Prog_4_user/Xlixv20_1/Vivado/2020.1/tps/boost_1_64_0
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_23 -L proc_sys_reset_v5_0_13 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="C:/Users/arify/Prog_4_user/Xlixv20_1/Vivado/2020.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
